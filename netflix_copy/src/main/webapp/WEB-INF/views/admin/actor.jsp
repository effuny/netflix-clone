                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Actor_manage</li>
                        </ol>
                         <div class="card mb-4">
                ...
                <!-- ==================관리자 추가 버튼=========== -->
		            ...
		            <!--================= 배우 수정 버튼================= -->
		                        		<button type="button" class="btn btn-primary btn-sm" id="modifyBtn"
					                        ...
					                        data-bs-whatever="@ado"
					                        data-modifyid="${actorList.id}"
					                        data-modifyname="${actorList.name}"
					                        data-manageurl="actor"
					                        data-name="배우">
					                        수정</button>
		            <!--================= 배우 삭제 버튼================= -->
                     ...
                     <!-- ==================배우 추가 모달 창=========== -->
                             ...
                             <div class="modal-dialog" >
                               <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                   ...
                                   <button type="button" class="btn btn-primary" onclick="acyncManageInsert('actorInsert.ado')" id="insertBtn">등록</button>
                                 </div>
                               </div>
                             </div>
                           </div>
                        ...
                        <div class="modal fade" id="modifyManage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                             <div class="modal-dialog" role="document">
                               <div class="modal-content">
                                 <div class="modal-header">
                                   <h5 class="modal-title" id="exampleModalLabel">배우 수정</h5>
                                   <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                 </div>
                                 <div class="modal-body">
                                 ...
                                 <div class="modal-footer">
                                 <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" >취소</button>
                                   <button type="button" class="btn btn-primary" onclick="acyncManageModify('actorModify.ado')">수정</button>
                                 </div>
                               </div>
                             </div>
                           </div>
      					...
      					<div class="modal fade" id="deleteManage">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											onclick="acyncManageDelete('actorDelete.ado')">예</button>
