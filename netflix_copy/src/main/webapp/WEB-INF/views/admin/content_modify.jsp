            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4 "><label id="category_name">${category_name } </label> 수정</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="adminDash.ado">Dashboard</a></li>
                            <li class="breadcrumb-item active">Content_Modify</li>
                        </ol>
	         		 ...
	         		 <div class="card ">
	           			 ...
	           			 <div class="card-body">
							    ...
							    <div>
							      ...
							      <input type="text" class="form-control " id="content_id"  name="content_id" value=${oneList.content_id } readonly>
							     </div>
							    <div>
							      <label>제목</label>
							      <input type="text" class="form-control " id="content_title"  name="content_title" value=${oneList.content_title } >
							     </div>
							    <div>
							      <label>영어 제목</label>
							      <input type="text" class="form-control " id="english_title"  name="english_title" value=${oneList.english_title }>
							     <br>
							     <div>
							      <label>제작 년도</label>
							      <input type="text" class="form-control " id="content_making" name="content_making" value=${oneList.content_making }>
							     </div>
							     <br>
							     <div>
							      <label>요약 설명</label>
							      <textarea class="form-control" id="summary" name="summary" >${oneList.summary }</textarea>
							     </div>
							     <br>
							     <div>
							      <label>재생 시간(분)</label>
							      <input type="number" class="form-control " id="runningtime" name="runningtime" value=${oneList.runningtime }>
							     </div>
						     	<br>
							 	<div>
							      <label>분류</label>
							...
							<div>
							      ...
							      <select class="form-control " id="is_main" name="is_main"	>
										<option value="${oneList.is_main }" seleted hidden>${oneList.is_main }</option>
	         		 ...
	         		 <div class="card">
	           			 ...
	           			 <div class="card-body">
							 ...
							 <div>
								...
								title="선택해 주세요">
							<option value="${oneList.country }" seleted hidden>${oneList.country }</option>
								...
								<option value="러시아">러시아</option>
							 	...
							 	<div >
							      ...
							      <select class="form-control" id="content_rating" name="content_rating"	>
										<option value="${oneList.content_rating }" seleted hidden>${oneList.content_rating }</option>
							   ...
							   <div>
							     ...
							     <select class="form-control" id="imagequality" name="imagequality"	>
										<option value="${oneList.imagequality }" seleted hidden>${oneList.imagequality }</option>
