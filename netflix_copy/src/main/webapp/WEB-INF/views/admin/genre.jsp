            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">장르 관리</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="adminDash.ado">Dashboard</a></li>
                            <li class="breadcrumb-item active">Genre_manage</li>
                        </ol>
                         <div class="card mb-4">
                ...
                <!-- ==================장르 추가 버튼=========== -->
		            ...
		            <!--================= 장르 수정 버튼================= -->
		                        		<button type="button" class="btn btn-primary btn-sm" id="modifyBtn"
					                        ...
					                        data-bs-whatever="@ado"
					                        data-modifyid="${genreList.id}"
					                        data-modifyname="${genreList.name}"
					                        data-manageurl="genre"
					                        data-name="장르">
					                        수정</button>
		            <!--================= 장르 삭제 버튼================= -->
                     ...
                     <!-- ==================장르 추가 모달 창=========== -->
                             ...
                             <div class="modal-dialog" >
                               <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                   ...
                                   <button type="button" class="btn btn-primary" onclick="acyncManageInsert('genreInsert.ado')" id="insertBtn">등록</button>
                                 </div>
                               </div>
                             </div>
                           </div>
                        ...
                        <div class="modal fade" id="modifyManage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                             <div class="modal-dialog" role="document">
                               <div class="modal-content">
                                 <div class="modal-header">
                                   <h5 class="modal-title" id="exampleModalLabel">장르 수정</h5>
                                   <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                 </div>
                                 <div class="modal-body">
                                 ...
                                 <div class="modal-footer">
                                 <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" >취소</button>
                                   <button type="button" class="btn btn-primary" onclick="acyncManageModify('genreModify.ado')">수정</button>
                                 </div>
                               </div>
                             </div>
                           </div>
      					...
      					<div class="modal fade" id="deleteManage">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-primary"
											onclick="acyncManageDelete('genreDelete.ado')">예</button>
