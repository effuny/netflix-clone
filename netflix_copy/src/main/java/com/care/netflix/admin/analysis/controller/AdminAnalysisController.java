package com.care.netflix.admin.analysis.controller;
...
public class AdminAnalysisController {
	...
	public String getAllMember(Model model){
      ...
      //==========나이별 데이터 정리====================================================
		    ...
		    for(int i = 0; AnalysisData.size() > i; i++){
		    	age=Math.abs(((Integer.parseInt(AnalysisData.get(i).get("birthyear"))-2022)-1));
    ...
    //==========멤버십 사용 여부 데이터 정리====================================================
		   ...
		   for(int i = 0; monthAnalysisData.size() > i; i++){
			   if(monthAnalysisData.get(i).get("membership_chk")== null) {
				   no++;				   
			   }else {
