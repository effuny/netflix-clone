package com.care.netflix.admin.dashboard;
...
import com.care.netflix.admin.content.service.IAdminContentService;
import com.care.netflix.admin.member.service.AdminMemberService;
...
public class AdminDashboardController {
	...
	public String getDashboard(Model model){
				...
				//========월별 매출 구하기=================================================
				    ...
				    for(int i = 0; monthAnalysisData2.size() > i; i++){
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("01")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Jan2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Jan2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("02")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Feb2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Feb2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("03")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Mar2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Mar2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("04")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Apr2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Apr2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("05")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	May2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	May2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("06")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Jun2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Jun2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("07")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Jul2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Jul2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("08")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Aug2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Aug2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("09")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Sep2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Sep2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("10")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Oct2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Oct2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("11")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Nov2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Nov2+=17000;	}
				    		}
				    	if(monthAnalysisData2.get(i).get("month").toString().equals("12")) {
				    		...
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("standard")) {	Dec2+=13500;	}
				    		if(monthAnalysisData2.get(i).get("membership").toString().equals("premium")) {	Dec2+=17000;	}
				    		}
				    }
		...
		model.addAttribute("contentCnt",adminContentService.getTotalCount(null));
		 
		model.addAttribute("memberCnt",adminMemberService.getTotalCount(null));	//멤버 수 전송
		
		model.addAttribute("salesCnt", Jan2+Feb2+Mar2+Apr2+May2+Jun2+Jul2+Aug2+Sep2+Oct2+Nov2+Dec2);
